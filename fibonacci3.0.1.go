...
func fibClosure() func(uint, ...bool) uint64 {
	...
	var fibNum func(uint, ...bool) uint64
	...
	fibNum = func(n uint, caheArg ...bool) (result uint64) {
		i++
		...
		if n <= 1 {
			...
			//... значит множество параметров, в т. числе и ничего, т.е. без этого параметра
			return fibNum(n-1, caheArg...) + fibNum(n-2, caheArg...)
		}
	}
	return fibNum
}
